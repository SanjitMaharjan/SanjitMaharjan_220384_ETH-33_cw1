...
<body>
  <section style="min-height: 100vh;" class="mb-5">
    <header>
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="/">TEN <span style="color: Brown;">11</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <form class="form-inline mt-2 mt-md-0" action="/dashboard" method="GET">
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 pages">
                    <h2>Quick Links</h2>
                    <ul>
                        <li><a href="/">Home</a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 contacts">
                    <h2>Contacts</h2>
                    <ul>
                        <li><a href="tel://9845430469">+977 9845430469</a></li>
                        <li><a href="mailto:sanjitmhrjn@gmail.com">sanjitmhrjn@gmail.com</a></li>
                        <li><a href="">Khokana</a></li>
                    </ul>
                </div>
                <div class="profile">
                <div class="social-links mt-3 text-center">
                    <a href="https://www.linkedin.com" class="Linkedin"><i class="fa fa-linkedin-square"></i></a>
                    <a href="https://www.twitter.com" class="twitter"><i class="fa fa-twitter-square"></i></a>
                    <a href="https://www.facebook.com/SanjitMaharjan.1011" class="facebook"><i class="fa fa-facebook-official"></i></a>
